<ul class="navbar-nav bg-gradient-primary sidebar sidebar accordion" id="accordionSidebar">
    ...
    <li class="nav-item {{ (request()->is('admin')) ? 'active' : '' }}">
        <a class="nav-link intd" href="{{ route('admin.userprofile') }}">
    ...
    <li class="nav-item {{ (request()->is('admin/intake')) ? 'active' : '' }}">
        <a class="nav-link intd" href="{{ route('admin.intake') }}">
    ...
    <li class="nav-item {{ (request()->is('admin/testimonial')) ? 'active' : '' }}">
        <a class="nav-link intd" href="{{ route('admin.testimonial') }}">
    ...
    <li class="nav-item  {{ (request()->is('admin/users')) ? 'active' : '' }}">
        <a class="nav-link intd" href="{{ route('users.index') }}">
    ...
    <li class="nav-item {{ (request()->is('admin/services')) ? 'active' : '' }}">
        <a class="nav-link intd" href="{{ route('admin.services') }}">
            <i class="fas fa-fw fa-cog"></i>
            <span> Begeleider </span>
        </a>
    </li>

    <li class="nav-item {{ (request()->is('admin/services-provider')) ? 'active' : '' }}">
        <a class="nav-link intd" href="{{ route('admin.services-provider') }}">
            <i class="fas fa-fw fa-cog"></i>
    ...
    <li class="nav-item {{ (request()->is('admin/payment-history')) ? 'active' : '' }}">
        <a class="nav-link intd" href="{{ route('admin.payment-history') }}">
            <i class="fas fa-fw fa-cog"></i>
    ...
    <li class="nav-item {{ (request()->is('admin/mailbox')) ? 'active' : '' }}">
        <a class="nav-link intd" href="{{ route('admin.mailbox') }}">
        <i class="fa fa-users"></i>
            <span>Mailbox</span>
        </a>
    </li> 
    ...
    <li class="nav-item">
        <a class="nav-link intd" href="{{ route('frontend.home') }}">
        <i class="fa fa-eye"></i>
            <span>Website</span>
        </a>
    </li> 
    <li class="nav-item">
        <a class="nav-link intd" href="{{ url('/logout') }}">
        <i class="fas fa-fw fa-cog"></i>
            <span>Uitloggen</span>
        </a>
    </li> 
