...
@section('content')
    <section class="hero">
        <div class="container">
            <div class="home-hero-text">
                <h1 style="text-transform: uppercase">IK ZOEK EEN huishoudelijke hulp</h1>
            </div>
        </div>
    </section>
    ...
    <section class="zoek-view-sec">
        <div class="container"> 
            <h1 class="mb-5" style="font-size: 2.4rem; font-family: Arial, Helvetica, sans-serif; margin-bottom: 30px;">Huishoudelijke Hulp</h1>
        </div>
        <div class="container">
                ...
                <div class="left-sidebar-filter-wrap">
                    <form action="" method="GET">
                        <div class="services-filter"> 
                            ...
                            <div class="filter-wrap">
                                <span>Specifieke ervaring noodzakelijk met: </span>
                                @php 
                                $spe_exp = isset($_GET['specific_experience']) ? $_GET['specific_experience'] : '';
                                @endphp
                                <select name="other" id="">
                                    <option value="">Selecteer</option>
                                    <option value="Geen eisen" {{ $spe_exp == 'Geen eisen' ? 'selected' : ''}}>Geen eisen</option>
                                    <option value="Autisme" {{ $spe_exp == 'Autisme' ? 'selected' : ''}}>Autisme</option>
                                    <option value="ADHD" {{ $spe_exp == 'ADHD' ? 'selected' : ''}}>ADHD</option>
                                    <option value="Verslaving" {{ $spe_exp == 'Verslaving' ? 'selected' : ''}}>Verslaving</option>
                                    <option value="NAH" {{ $spe_exp == 'NAH' ? 'selected' : ''}}>NAH</option>
                                    <option value="Rolstoel gebonden mensen" {{ $spe_exp == 'Rolstoel gebonden mensen' ? 'selected' : ''}}>Rolstoel gebonden mensen</option>
                                    <option value="Angststoornis" {{ $spe_exp == 'Angststoornis' ? 'selected' : ''}}>Angststoornis</option>
                                    <option value="Borderline-persoonlijkheidsstoornis" {{ $spe_exp == 'Borderline-persoonlijkheidsstoornis' ? 'selected' : ''}}>Borderline-persoonlijkheidsstoornis</option>
                                    <option value="Dementie" {{ $spe_exp == 'Dementie' ? 'selected' : ''}}>Dementie</option>
                                    <option value="Eetstoornissen" {{ $spe_exp == 'Eetstoornissen' ? 'selected' : ''}}>Eetstoornissen</option>
                                    <option value="Fobiën" {{ $spe_exp == 'Fobiën' ? 'selected' : ''}}>Fobiën</option>
                                </select>
                            </div>
                            <div class="filter-wrap">
                                <span>Overig</span>
                ...
                <div class="zoek-cards-wrap">
                    ...
                    @foreach($services as $service)
                        <div class="zoek-main-card">
                            <a href="{{ url('zorgverleners/'.$service->id) }}">
